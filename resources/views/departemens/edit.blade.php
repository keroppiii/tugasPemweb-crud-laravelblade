                ...
                <div class="card-body" style="background-color: #fce4ec; border-radius: 1rem;">
                    <form action="{{ route('departemens.update', $departemen->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control rounded-3" id="nama_departemen" name="nama_departemen" value="{{ $departemen->nama_departemen }}" required>
                        </div>

                        <div class="mb-3">
                            <label for="kode" class="form-label text-muted">Kode</label>
                            <input type="text" class="form-control rounded-3" id="kode" name="kode" value="{{ $departemen->kode }}" required>
                        </div>

                        <div class="mb-3">
                            <label for="penanggung_jawab" class="form-label text-muted">Penanggung Jawab</label>
                            <input type="text" class="form-control rounded-3" id="penanggung_jawab" name="penanggung_jawab" value="{{ $departemen->penanggung_jawab }}" required>
                        </div>

                        <div class="d-flex justify-content-end">
                            <a href="{{ route('departemens.index') }}" class="btn btn-outline-secondary me-2">Batal</a>
